/*
 * Sox headers adapted by Amar Chaudhary for use in Open Sound Library
 *
 * July 5, 1991
...
/*
 * May, 1999.  Fixed declarations for C++ (Amar Chaudhary)
 */
...
typedef struct format {
	...
	void	(*startread)(struct soundstream *);			
	LONG	(*read)(struct soundstream *, long *, long);			
	void	(*stopread)(struct soundstream *);		
	void	(*startwrite)(struct soundstream *);			
	void	(*write)(struct soundstream *, long *, long);
	void	(*stopwrite)(struct soundstream *);		
} format_t;
...
#if	defined(__STDC__) || defined(__cplusplus) || defined(ARM)
#define	P1(a) a
#define	P2(a,b) a, b
...
// don't now of any platform we (CNMAT) support where the "b" doesn't
// work (what about the Mac?) -AC
